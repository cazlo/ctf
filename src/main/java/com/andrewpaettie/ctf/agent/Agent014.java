package com.andrewpaettie.ctf.agent;

import com.andrewpaettie.ctf.common.AgentAction;
import com.andrewpaettie.ctf.common.AgentEnvironment;

import java.util.*;

/**
 * Created by Andrew Paettie on 9/29/18.
 * Copy of Agent007 so it can be safely pitted against itself
 * without refactoring the classloading too much
 */
public class Agent014 extends Agent {
...
//    public int agentIdentifier;
    ...
    public  boolean initialMove = true;
    public  DIRECTION friendlyBaseWestOrEast = null;
    ...
    public  ArrayList<Node> pendingMoves = new ArrayList<Node>();
    public  boolean capperCantMove = false;
    ...
    public int getMove( AgentEnvironment inEnvironment ){
        ...
        try {
            ...
            // todo hack - sometimes moves aren't registering so things get nulled out erroneously
        }
